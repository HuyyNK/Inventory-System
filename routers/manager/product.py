...
from procedures.manager.product import get_products, get_next_sku, add_product
...
async def add_product_page(request: Request, user: dict = Depends(get_current_user)):
    ...
    return templates.TemplateResponse("manager/product/add.html", {
        ...
        "storage_options": ['Chilled Storage', 'Ambient Storage', 'Frozen Storage']  # Fixed options
    })
...
async def create_product(
    ...
    unit: str = Form(None),  # New field for unit
    ...
    try:
        ...
        product_data = {
            ...
            "unit": unit,  # Add unit to product data
