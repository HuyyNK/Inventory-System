...
from routers.manager.outbound import router as manager_outbound_router  # Thêm outbound router
...
app.include_router(manager_outbound_router)  # Thêm outbound router
